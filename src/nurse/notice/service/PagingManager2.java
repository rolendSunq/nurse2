...
@Service("pagingManager2")
public class PagingManager2 {

	private static final PagingManager2 pagingManager = new PagingManager2();
	private static final Logger logger = LoggerFactory.getLogger(PagingManager2.class);
	
	public static PagingManager2 getInstance(){
